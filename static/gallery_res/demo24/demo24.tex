...
\begin{document}
\[
\textit{E} = \frac{1}{\textit{σ\_N}^{2}}\textit{E\_I} + \sum_{\textit{j} > 1} \frac{\textit{α}_{ \textit{j} }^{2}}{\textit{σ\_S}_{ \textit{j} }^{2}} + \sum_{\textit{j} > 1} \frac{\textit{β}_{ \textit{j} }^{2}}{\textit{σ\_T}_{ \textit{j} }^{2}} + \sum_\textit{j} \frac{(\textit{ρ}_{ \textit{j} } - \textit{ρ̄}_{ \textit{j} })^{2}}{\textit{σ\_ρ}_{ \textit{j} }^{2}}
\]
...
\item $\textit{ρ̄}_{\textit{i}} \in \mathbb{{R}}$
